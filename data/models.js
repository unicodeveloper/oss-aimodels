const modelsDatabase = [
    ...
    },
    {
        ...
        provider: "Hugging Face",
        category: "language",
        description: "Hybrid foundation model with multiplicative gates and short convolutions, optimized for on-device deployment with 350M parameters.",
        plainDescription: "A compact AI model that runs efficiently on your device for conversations, text tasks, and data extraction without needing internet connection.",
        useCases: ["Agentic Tasks", "Data Extraction", "RAG", "Creative Writing", "Multi-turn Conversations"],
        inputModalities: ["Text"],
        outputModalities: ["Text"],
        technicalSpecs: {
            parameters: "350M",
            memoryRequired: "1GB RAM",
            hardwareRequirement: "CPU, GPU, NPU compatible",
            inferenceSpeed: "Very Fast",
        ...
        stars: "1.2K",
        date: "2025-07-13",
        tags: ["hybrid", "on-device", "edge-ai", "convolution", "multilingual"],
        githubUrl: "https://github.com/Liquid-AI/LFM2",
        huggingtfaceUrl: "https://huggingface.co/LiquidAI/LFM2-350M"
    },
    {
        name: "LFM2-700M",
        author: "Liquid AI",
        provider: "Hugging Face",
        category: "language",
        description: "Mid-size hybrid foundation model with 700M parameters, featuring multiplicative gates and short convolutions for efficient on-device deployment.",
        plainDescription: "A balanced AI model that offers good performance while running efficiently on your device for various text and conversation tasks.",
        useCases: ["Agentic Tasks", "Data Extraction", "RAG", "Creative Writing", "Multi-turn Conversations"],
        inputModalities: ["Text"],
        outputModalities: ["Text"],
        technicalSpecs: {
            parameters: "700M",
            memoryRequired: "2GB RAM",
            hardwareRequirement: "CPU, GPU, NPU compatible",
            inferenceSpeed: "Very Fast",
            formats: ["PyTorch", "GGUF"],
            toolCalling: "Yes",
        ...
        tags: ["hybrid", "on-device", "edge-ai", "convolution", "multilingual"],
        githubUrl: "https://github.com/Liquid-AI/LFM2",
        huggingtfaceUrl: "https://huggingface.co/LiquidAI/LFM2-700M"
    },
    {
        name: "LFM2-1.2B",
        author: "Liquid AI",
        provider: "Hugging Face",
        category: "language",
        description: "Largest variant of the LFM2 series with 1.2B parameters, featuring hybrid architecture with multiplicative gates and short convolutions for superior on-device performance.",
        plainDescription: "The most capable version of LFM2 that delivers excellent performance while still running efficiently on your device for complex text tasks.",
        useCases: ["Agentic Tasks", "Data Extraction", "RAG", "Creative Writing", "Multi-turn Conversations"],
        inputModalities: ["Text"],
        outputModalities: ["Text"],
        technicalSpecs: {
            parameters: "1.2B",
            memoryRequired: "3GB RAM",
            hardwareRequirement: "CPU, GPU, NPU compatible",
            inferenceSpeed: "Fast",
            formats: ["PyTorch", "GGUF"],
            toolCalling: "Yes",
        ...
        tags: ["hybrid", "on-device", "edge-ai", "convolution", "multilingual"],
        githubUrl: "https://github.com/Liquid-AI/LFM2",
        huggingtfaceUrl: "https://huggingface.co/LiquidAI/LFM2-1.2B"
    }
];
